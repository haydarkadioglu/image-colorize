...
load_data("F:\\Restoresyon\\data\\mix", (512,512))


# %%

n=5000
lr_list = os.listdir("data/mix")

lr_images = []
for img in lr_list:
    img_lr = cv2.imread("data/lr_images/" + img)
    img_lr = cv2.resize(img_lr, dsize=(128,128))
...
for img in hr_list:
    ...
    img_hr = cv2.resize(img_hr, dsize=(128,128))
